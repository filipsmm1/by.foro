...
{picture(PETAL_ROOT, "ariana-petal-chart-impact", "Ariana Grande singing under blue stage lighting during the Dangerous Woman Tour in 2017")}
...
{picture(PETAL_ROOT, "ariana-petal-next-week", "Ariana Grande at a New York film premiere in 2011")}
...
<section class="source-note"><h2>Sources, method and image credits</h2><p>Streaming positions and filtered counts come from <a href="https://kworb.net/spotify/country/global_daily.html">Kworb&rsquo;s archive of Spotify&rsquo;s global daily chart</a> and its <a href="https://kworb.net/spotify/country/global_daily_totals.html">global chart totals</a>, checked through 7 August 2026. Release context was checked against the <a href="https://apnews.com/article/ariana-grande-petal-album-music-review-6c689addb7892b2f08aa57568e722bb2">Associated Press review published 31 July 2026</a>. The UK result and career total were checked against <a href="https://www.officialcharts.com/artist/26221/ariana-grande/">Ariana Grande&rsquo;s Official Charts history</a>. Calculations use only displayed filtered counts; no fan estimate is presented as an official result.</p><p>Photographs: Emma / esheehanphotos, Dangerous Woman Tour, 19 February 2017, via Wikimedia Commons (<a href="https://commons.wikimedia.org/wiki/File:Ariana_Grande_(32426962484).jpg">hero</a> and <a href="https://commons.wikimedia.org/wiki/File:Ariana_Grande_(33141791801).jpg">stage portrait</a>), licensed <a href="https://creativecommons.org/licenses/by-sa/2.0/">CC BY-SA 2.0</a>; Joella Marano, New York film premiere, 10 July 2011, via <a href="https://commons.wikimedia.org/wiki/File:Ariana_Grande.jpg">Wikimedia Commons</a>, licensed CC BY-SA 2.0. These are sharp archival photographs, not <em>Petal</em> campaign images. They have been cropped and compressed for the page.</p></section>
    ...
    new = [
        {
            ...
            "image": {"webp": f"{PETAL_HERO}.webp", "fallback": f"{PETAL_HERO}.jpg", "alt": "Ariana Grande smiling with a microphone during the Dangerous Woman Tour in 2017", "width": 1536, "height": 1024},
...
def main() -> None:
    write_article(PETAL_URL, page(PETAL_URL, PETAL_SEO, PETAL_TITLE, PETAL_DESCRIPTION, "A 62.2 million-stream opening put every track in Spotify&rsquo;s global top 15. One week later, <em>Petal</em> became Ariana Grande&rsquo;s sixth UK number-one album.", "Culture", "Music", PETAL_HERO, "Ariana Grande smiling with a microphone during the Dangerous Woman Tour in 2017", petal_body, "NewsArticle", 2250, ["Ariana Grande Petal streams", "Petal first week streams", "Petal Spotify ranking", "Ariana Grande Petal UK chart debut"]))
